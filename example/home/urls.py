...
from home.views import delete_profile_picture, edit_book, get_view, index, detail_book_view, display, add_book, post_book, profile, delete_book, profile_picture
